			...
			@outgoing = Outgoing.new(to_phone: @incoming.from_phone, 
															 body: (
																  @incoming.medias.count > 0 ? 
																 	"It looks like you have a #{@incoming.medias.first.description.titleize}." : "Let's get started. Using a mirror, take a picture of your phone. Try and capture just the phone -- so a computer can recognize the image, and remember to turn of the flash. Attach the picture and reply to this message."),
